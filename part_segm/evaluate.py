...
parser.add_argument('--model', default='acnn_segm_rings', help='Model name [default: pointnet2_part_seg]')
parser.add_argument('--model_path', default='log/model.ckpt', help='model checkpoint file path [default: log/model.ckpt]')
parser.add_argument('--log_dir', default='log/log_eval', help='Log dir [default: log_eval]')
...
def evaluate():
    with tf.Graph().as_default():
        with tf.device('/gpu:'+str(GPU_INDEX)):
            ...
            pred, end_points = MODEL.get_model(pointclouds_pl, cls_labels_pl, normals_pl, is_training_pl)
